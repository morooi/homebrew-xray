...
curl -s -L "https://raw.githubusercontent.com/XTLS/Xray-examples/main/VLESS-TCP-XTLS-Vision/config_client.jsonc" > config_client.json || { echo 'Config file download failed!' ; exit 1; }
