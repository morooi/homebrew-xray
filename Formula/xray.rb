class Xray < Formula
  ...
  on_arm do
    ...
    sha256 "e086f0d588d6f3d8d5d7983313930119bd0bd9935671bdd9fe1c400c6cd38599" # Apple Silicon
  end
  ...
  resource "geosite" do
    ...
    sha256 "e9b58a19d3966f14ef694fbe870cbe3a26de0bd900acdfc3926523ba881fe858" # GeoSite
  end
