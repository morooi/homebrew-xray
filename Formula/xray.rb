class Xray < Formula
  ...
  on_intel do
    ...
    sha256 "8e8052a0c2d1b3568998cc84bea4b37c23a7db71d547cf8f34b6b109f2f55a30" # Intel
  end
  ...
  resource "geosite" do
    ...
    sha256 "61a399fcd21c300cf8150299539d1333aa006ac656dc0c0d2d3cfc95dd74a4ab" # GeoSite
  end
