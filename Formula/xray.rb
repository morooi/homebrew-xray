class Xray < Formula
  ...
  if Hardware::CPU.intel?
    ...
    sha256 "43427e869025235d1e81fca6ce21b920192772c9e51b7e76d33a4534a95e7460" # Intel
  else
    url "https://github.com/XTLS/Xray-core/releases/download/v1.5.9/Xray-macos-arm64-v8a.zip"
    sha256 "436e1620d5e4367359aa6d2f514aceeb8eb9d79cea3251934a8c3f6682704565" # Apple Silicon
  end
  version "1.5.9"
  license "MPL-2.0"
  ...
  resource "geoip" do
    ...
    sha256 "2e27232fbbbc0780b17e8c8411678e55597f50653a13eab241dd20731189138a" # GeoIP
  end

  resource "geosite" do
    url "https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geosite.dat"
    sha256 "4262030f7ea40daa7e5b669a537d74d13a087b7ae1d9b976b673039c652e10a2" # GeoSite
  end
