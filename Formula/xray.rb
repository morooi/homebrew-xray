class Xray < Formula
  ...
  on_arm do
    url "https://github.com/XTLS/Xray-core/releases/download/v25.12.8/Xray-macos-arm64-v8a.zip"
    sha256 "cde3406670061f4b9fad672727d1e616e6c335db2fb414456991c0246a368c7c" # Apple Silicon
  end
  ...
  resource "geoip" do
    ...
    sha256 "02182001b30f192d678ff5c52aff82d839852b66bab851a5e5c571615f18c857" # GeoIP
  end

  resource "geosite" do
    url "https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geosite.dat"
    sha256 "bef875edee0ee229ac8e0a7664a29b650e4354407cc337be1e6047cd8c0149c0" # GeoSite
  end
