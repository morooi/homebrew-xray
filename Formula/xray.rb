class Xray < Formula
  ...
  if Hardware::CPU.intel?
    ...
    sha256 "2f0b74f2a8a8de636f04ed7eec73ede80550b5e8078657e555f996940100cd19" # Intel
  else
    url "https://github.com/XTLS/Xray-core/releases/download/v25.4.30/Xray-macos-arm64-v8a.zip"
    sha256 "2f0b74f2a8a8de636f04ed7eec73ede80550b5e8078657e555f996940100cd19" # Apple Silicon
  end
  version "25.4.30"
  license "MPL-2.0"
  ...
  resource "geoip" do
    ...
    sha256 "9eb7dcaac433cefd96c5f5d83e88ec489c17c58a905f858824bafdc65f63ad92" # GeoIP
  end

  resource "geosite" do
    url "https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geosite.dat"
    sha256 "9242825308ae85c464924128f6373e72543aca3fde1d9ea532c24335aba19dd0" # GeoSite
  end
