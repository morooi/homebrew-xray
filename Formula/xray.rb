class Xray < Formula
  ...
  if Hardware::CPU.intel?
    ...
    sha256 "179b72d33101658caff9506341b5aa8a8535df97abf58b944e7588e5a5aac01f" # Apple Silicon
  end
  version "1.3.0"
  license "MPL-2.0"
  ...
  resource "geoip" do
    ...
    sha256 "1a57d6f55dd57ad0b7e4da77b59fffdd5bef1e63864069c7f846847f59e6cdb1" # GeoIP
  end

  resource "geosite" do
    url "https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geosite.dat"
    sha256 "f67512ef2ef68c58f425b61f95d188df421f731e6fa3c77246873d9db7776dc1" # GeoSite
  end
