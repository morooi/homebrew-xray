class Xray < Formula
  ...
  if Hardware::CPU.intel?
    ...
    sha256 "7228402b6700b6313587458f37094b7d2d8db3da41f3cfb2612b3cc469498116" # Intel
  else
    url "https://github.com/XTLS/Xray-core/releases/download/v1.4.2/Xray-macos-arm64-v8a.zip"
    sha256 "08f1fdf2bf740aefaaf049d1305c6206ef827b5fedbf738f97dcf01318638331" # Apple Silicon
  end
  version "1.4.2"
  license "MPL-2.0"
  ...
  resource "geoip" do
    ...
    sha256 "f5060c2b655d191bb5e3685c15d408da0c85b9455cb199fc34dc6c82490452bf" # GeoIP
  end

  resource "geosite" do
    url "https://raw.githubusercontent.com/Loyalsoldier/v2ray-rules-dat/release/geosite.dat"
    sha256 "6b3619802cba950835479b95087718f8cc46b2797609c79f30bee7a11ac82b6b" # GeoSite
  end
